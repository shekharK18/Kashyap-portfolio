    ...
    <section id='experience' className='experience max-w-7xl mx-auto px-3 py-16 sm:py-20'>
      ...
      <div className="experienceContainer flex flex-col md:flex-row mx-8 md:mx-0 py-14 sm:py-7">
        ...
        <div className="content md:w-1/2 flex flex-col justify-center text-center sm:text-left gap-2">
          {/* Render fetched experience cards */}
          {
            data && data.length > 0 && data.map((item: TypeExperience) => (
              <ExperienceCard
                key={item._id}
          ...
          {/* ➕ Static DevOps Experience Card */}
          <ExperienceCard
            key="devops-entry"
            company="Freelance / Personal Projects"
            role="Frontend & DevOps Engineer"
            year=""
            desc="Developed and deployed modern frontend apps with DevOps practices. Set up CI/CD pipelines using GitHub Actions, containerized apps with Docker, and deployed to AWS (S3 + CloudFront) and Vercel. Monitored performance with Lighthouse CI and tracked errors via Sentry."
          />
        </div>
      </div>
    </section>
